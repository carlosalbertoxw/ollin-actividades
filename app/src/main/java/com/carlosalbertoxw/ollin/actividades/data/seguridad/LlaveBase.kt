 ...
 *
 * La frase se representa en hexadecimal a proposito. SQLCipher deriva su llave
 * del texto que recibe, y con caracteres imprimibles el resultado es el mismo
 * por cualquier camino por el que se le entregue: hoy solo la pasa Room como
 * bytes, pero si mas adelante aparece un ATTACH ... KEY —una migracion, una
 * exportacion— la llave seguira coincidiendo. Con bytes crudos los dos caminos
 * derivarian llaves distintas y la base quedaria ilegible.
 */
object LlaveBase {

    private const val ARCHIVO = "ollin_llave"
    private const val CAMPO = "frase_envuelta"
    private const val ALIAS = "ollin_actividades_maestra"
