...
object Estilo {
    ...
    const val ENCABEZADO = 6
    const val NEGRITA = 7
    const val TITULO = 8
    const val TENUE = 9
    const val SUBTITULO = 10
    const val ENTERO_TOTAL = 11
    const val PORCENTAJE_TOTAL = 12
}
...
sealed interface Celda {
    ...
    /** Hora suelta: se guarda como fraccion del dia, que es lo que entiende Excel. */
    data class Hora(val valor: LocalTime, override val estilo: Int = Estilo.HORA) : Celda
