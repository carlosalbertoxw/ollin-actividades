package com.carlosalbertoxw.ollin.actividades.ui.theme
...
private val EsquemaOscuro = darkColorScheme(
    primary = Pigmento.AnilClaro,
    onPrimary = Pigmento.Obsidiana,
    primaryContainer = Pigmento.AnilTenue,
    onPrimaryContainer = Pigmento.AnilClaro,
    secondary = Pigmento.JadeClaro,
    onSecondary = Pigmento.Obsidiana,
    secondaryContainer = Pigmento.JadeTenue,
    onSecondaryContainer = Pigmento.JadeClaro,
...
private val EsquemaClaro = lightColorScheme(
    primary = Pigmento.Anil,
    onPrimary = Color.White,
    primaryContainer = Color(0xFFDCE6F7),
    onPrimaryContainer = Color(0xFF13294A),
    secondary = Pigmento.Jade,
    onSecondary = Color.White,
    secondaryContainer = Color(0xFFD4EDE0),
    onSecondaryContainer = Color(0xFF0C3A25),
...
/**
 * Tipografia sobria. Aqui la protagonista es la duracion, asi que los tiempos
 * van monoespaciados y con peso, y el texto se hace a un lado.
 */
...
/** Estilo para tiempos: ancho fijo por digito para que el cronometro no baile. */
val EstiloTiempo = TextStyle(
